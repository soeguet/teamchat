package com.soeguet.properties.generated;
...
public abstract class PropertiesPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        // ======== form_panel4 ========
        {
            ...
            form_closePropertiesPanelButton.addMouseListener(
                    new MouseAdapter() {
                        @Override
        ...
        // ======== form_formerMessagePanel ========
        {
            ...
            // ======== form_tabbedPane ========
            {
                    ...
                    // ======== form_clientsPanel2 ========
                    {
                        ...
                        // ======== form_panel10 ========
                        {
                            ...
                            // ======== form_panel14 ========
                            {
                                ...
                                {
                                    form_ownBorderColorPanel.setBorder(
                                            new LineBorder(Color.black, 1, true));
                                    form_ownBorderColorPanel.addMouseListener(
                                            new MouseAdapter() {
                                                @Override
                ...
                {
                    form_clientsScrollPane.setHorizontalScrollBarPolicy(
                    ...
                    // ======== form_clientsPanel ========
                    {
                        ...
                        // ======== form_panel5 ========
                        {
                            ...
                            // ======== form_panel6 ========
                            {
                                ...
                                form_clientSelectorComboBox.addItemListener(
                                        e -> clientSelectorComboBoxItemStateChanged(e));
                            ...
                            // ======== form_panel9 ========
                            {
                                ...
                                {
                                    form_colorPickerPanel.setBorder(
                                            new LineBorder(Color.black, 1, true));
                                    form_colorPickerPanel.addMouseListener(
                                            new MouseAdapter() {
                                                @Override
                                                public void mouseClicked(MouseEvent e) {
        ...
        // ======== form_panel1 ========
        {
            ...
            // ======== form_panel11 ========
            {
                ...
                // ======== form_panel12 ========
                {
                    ...
                    ((GridBagLayout) form_panel12.getLayout()).columnWeights =
                            new double[] {1.0, 1.0E-4};
                    ((GridBagLayout) form_panel12.getLayout()).rowWeights =
                            new double[] {1.0, 1.0E-4};
                    ...
                    form_propertiesOkButton.addMouseListener(
                            new MouseAdapter() {
                                @Override
                                public void mousePressed(MouseEvent e) {

...
public class PropertiesPanelImpl extends PropertiesPanel implements PropertiesInterface {
  ...
  /**
   * This method sets the position of the current element. It sets the bounds of the element based
   * on the size of the main text panel in the GUI. The element is added to the main text panel
   * layered pane with a modal layer.
   */
  @Override
  ...
  /**
   * This method sets up the own tabbed pane with the custom user properties. It sets the
   * timeAndUsername text field with the timeAndUsername from the own client properties. It sets the
   * background color of the border color panel with the border color from the own client
   * properties.
   */
  @Override
  public void setupOwnTabbedPane() {
    ...
    // PropertiesRegister.getPropertiesRegisterInstance();
    //
    //        CustomUserPropertiesDTO ownClient =
    // propertiesRegister.getChatClientPropertiesHashMap().get("own");
    //
    //        if (ownClient == null) {
    //
  ...
  /**
   * This method sets up the clients tabbed pane. It adds clients to the combo box and sets up
   * components on the properties panel.
   */
  @Override
  ...
  /**
   * This method adds clients to the combo box. It retrieves the main frame from the GUI and asserts
   * that it is not null. For each client in the chat client properties hash map, the client is
   * added to the combo box. The selected item in the combo box is retrieved as a string. The
   * selected client in the combo box is set based on the chat client properties hash map.
   */
  ...
  /**
   * This method sets up the components on the properties panel using the given CustomUserProperties
   * object. It sets the timeAndUsername text field with the timeAndUsername from the
   * CustomUserProperties object. It sets the nickname text field with the nickname from the
   * CustomUserProperties object. It sets the background color of the color picker panel with the
   * border color from the CustomUserProperties object.
   */
  ...
  private void resetChatPanelOptionPane() {
    ...
    int result =
        JOptionPane.showConfirmDialog(
            this, "do you want to reset the chat?", "reset", JOptionPane.OK_CANCEL_OPTION);
  ...
  protected void ownBorderColorPanelMouseClicked(MouseEvent e) {
    ...
    //
    //        final String nickname = ownProperties.nickname() == null ? null :
    ...
    //            CustomUserPropertiesDTO updatedOwnProperties = new
    // CustomUserPropertiesDTO(ownProperties.username(),
    //
    // nickname,
    //
  ...
  protected void propertiesOkButtonMousePressed(final MouseEvent e) {
    ...
    //
    //        final CustomUserPropertiesDTO ownPropertiesDTO =
    // chatClientPropertiesHashMap.get("own");
    //        final CustomUserPropertiesDTO updatedPropertiesDTO =
    // ownPropertiesDTO.withUsername(ownName);
    ...
    //            selectedClientInComboBox =
    // mainFrame.getChatClientPropertiesHashMap().get(selectedUsername);
    //        }
    //
    //        ///
    //
    ...
    //        mainFrame.getChatClientPropertiesHashMap().replace(username, new
    // CustomUserPropertiesDTO(username, nickname,
    //
  ...
  protected void colorPickerPanelMouseClicked(MouseEvent e) {
    ...
    // Color(mainFrame.getChatClientPropertiesHashMap().get(selectedItem).getBorderColor());
    //
    //        Color color = JColorChooser.showDialog(this, "Choose a color", borderColor);
    //
    //        if (color != null) {

...
public class ChatMainFrameImpl extends ChatPanel {
    ...
    public void setMainFrameTitle() {
        ...
        final String title = "teamchat" + " - " + this.chatVersion() + "client name: " + this.getUsername();
    ...
    /**
     ...
     If the client properties are successfully loaded, the method sets the statusArray property to the statusArray
     obtained from the CustomUserProperties object.
     */
    ...
    /**
     ...
     the current object as a constructor argument. The GuiFunctionality object is then assigned to the guiFunctionality
    ...
    /**
     ...
     current instance of the ChatMainFrameImpl class and the guiFunctionality object. It then calls the
     determineWebsocketURI() method and the connectToWebsocket() method on the clientController object.
     */
    ...
    protected void emojiButton(final ActionEvent e) {
        ...
        final EmojiPopupInterface emojiPopup = new EmojiPopUpMenuHandler(this.form_textEditorPane,
                                                                         this.form_emojiButton);
    ...
    private String chatVersion() {
        ...
        final InputStream inputStream = this.getClass().getClassLoader().getResourceAsStream("version.properties");

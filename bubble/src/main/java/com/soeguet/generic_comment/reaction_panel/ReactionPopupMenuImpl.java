...
public class ReactionPopupMenuImpl extends JPopupMenu {
  ...
  /**
   * This class represents a reaction popup menu implementation. It provides functionality to handle
   * reactions in a popup menu.
   */
              ...
              if (component instanceof JLabel) {
                ...
                try {
                  ...
                  logger.log(
                      ...
                      "PLACE: ReactionPopupMenuImpl >" + " " + "createReactionEmojiPanel");
                  logger.log(
                      java.util.logging.Level.SEVERE, jsonProcessingException.getMessage(), e);
                ...
                final CustomWebsocketClient customWebsocketClient =
                    clientRegister.getCustomWebsocketClient();
   ...
   * outside the boundaries of the component. It returns true if the mouse coordinates are less than
   * or equal to 0 on the x-axis, greater than or equal to the width of the component on the x-axis,
   * less than or equal to 0 on the y-axis, and greater than or equal to the height of the component
   * on the y-axis.
   *

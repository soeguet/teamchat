...
import com.soeguet.generic_comment.factories.ReferencePanelFactory;
import com.soeguet.generic_comment.gui_elements.buttons.CustomCloseButton;
import com.soeguet.generic_comment.gui_elements.buttons.CustomReplySendButton;
...
public class CustomReplyPanel extends JPanel implements MouseListener, MouseMotionListener {
  ...
  // constructors -- start
  public CustomReplyPanel(BaseModel baseModel) {
  ...
  private void populateButtonPanel(final CustomSimpleJPanel buttonPanel) {
    ...
    // [3] SEND BUTTON
    CustomReplySendButton sendButton = new CustomReplySendButton(this.baseModel, this);
  ...
  private void populateReplyPanelReferenceSection() {
    ...
    CustomReferencePanel customReferencePanel =
        new ReferencePanelFactory(this.baseModel).createReferencePanel();

...
public class ClientControllerImpl implements ClientController {
      ...
      SwingUtilities.invokeLater(
          () ->
              JOptionPane.showMessageDialog(
                  null, errorMessage.toString(), "Error", JOptionPane.ERROR_MESSAGE));
    }
  }
  ...
  /** Reads the server IP and port from the environment variables and creates a websocket URI. */
  @Override
  ...
  public void serverInformationOptionPane() {
    ...
    int result =
        JOptionPane.showConfirmDialog(
            null, serverInfoPanel, "please enter ip and port values", JOptionPane.OK_CANCEL_OPTION);

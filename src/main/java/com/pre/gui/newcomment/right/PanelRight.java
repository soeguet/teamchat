...
public abstract class PanelRight extends JPanel {
	...
	private void initComponents() {
		...
		//======== form_layeredPane1 ========
		{
			...
			form_layeredPane1.setBackground(new Color(0xcc0033));
		}
		add(form_layeredPane1, "cell 1 1 2 2,grow");
		...
		add(form_nameLabel, "pad 0,cell 4 0 2 1,growx");
		...
		add(form_panel1, "pad 0,cell 2 0 1 2");
		...
		add(form_button1, "pad 0,cell 5 1");

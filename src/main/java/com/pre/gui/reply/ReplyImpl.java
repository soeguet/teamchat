...
import com.pre.gui.emoji.EmojiImpl;
import com.pre.gui.newcomment.left.PanelLeftImpl;
import com.pre.gui.newcomment.right.PanelRightImpl;
...
import static com.pre.gui.ChatImpl.client;
import static com.pre.gui.ChatImpl.mapOfIps;
...
public class ReplyImpl extends FeedbackDialog {
    ...
    protected void sendMessageReply() {
        ...
        try {
            ...
            MessageModel messageModel = new MessageModel(mapOfIps.get(client.getLocalSocketAddress().getHostString()), EmojiConverter.checkTextForEmojis(form_replyTextPane), this.messageModel.getSender(), this.messageModel.getTime(), this.messageModel.getMessage());

...
public abstract class Notification extends JDialog {
    ...
    private void initComponents() {
        ...
        // ======== form_notificationAllPanel ========
        {
            ...
            this.form_notificationAllPanel.addMouseListener(
                    new MouseAdapter() {
                        @Override
            ...
            // ======== form_panel9 ========
            {
                ...
                this.form_closeAllNotificationsButton.addActionListener(
                        e -> closeAllNotificationsActionPerformed(e));
            ...
            // ======== form_notificationMainPanel ========
            {
                ...
                // ======== form_panel7 ========
                {
                    ...
                    // ======== form_panel10 ========
                    {
                        ...
                        // ======== form_scrollPane1 ========
                        {
                            this.form_scrollPane1.setHorizontalScrollBarPolicy(
                                    ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
                            this.form_scrollPane1.setVerticalScrollBarPolicy(
                            ...
                            this.form_notificationMainMessage.setPreferredSize(
                                    new Dimension(62, 35));
                            this.form_scrollPane1.setViewportView(
                                    this.form_notificationMainMessage);
                        }
                    ...
                    // ======== form_panel8 ========
                    {
                        ...
                        this.form_notificationReplySendButton.setPreferredSize(
                                new Dimension(30, 30));
                        ...
                        this.form_notificationReplySendButton.addActionListener(
                                e -> notificationReplySendActionPerformed(e));
                        this.form_panel8.add(
                                this.form_notificationReplySendButton, BorderLayout.CENTER);
            ...
            this.form_notificationAllPanel.add(
                    this.form_notificationMainPanel, BorderLayout.CENTER);
        }

...
public class PropertiesPanelImpl extends PropertiesPanel implements PropertiesInterface {
     ...
     * timeAndUsername text field with the timeAndUsername from the own client properties. It sets
     * the background color of the border color panel with the border color from the own client
     * properties.
     */
    @Override
    ...
    /**
     * This method adds clients to the combo box. It retrieves the main frame from the GUI and
     * asserts that it is not null. For each client in the chat client properties hash map, the
     * client is added to the combo box. The selected item in the combo box is retrieved as a
     * string. The selected client in the combo box is set based on the chat client properties hash
     * map.
     */
    ...
    /**
     * This method sets up the components on the properties panel using the given
     * CustomUserProperties object. It sets the timeAndUsername text field with the timeAndUsername
     * from the CustomUserProperties object. It sets the nickname text field with the nickname from
     * the CustomUserProperties object. It sets the background color of the color picker panel with
     * the border color from the CustomUserProperties object.
     */
    ...
    protected void ownBorderColorPanelMouseClicked(MouseEvent e) {
        ...
        CustomUserPropertiesDTO ownProperties =
                mainFrame.getChatClientPropertiesHashMap().get("own");
        ...
        if (color != null) {
            ...
            CustomUserPropertiesDTO updatedOwnProperties =
                    new CustomUserPropertiesDTO(
                            ownProperties.username(), nickname, String.valueOf(color.getRGB()));
    ...
    protected void propertiesOkButtonMousePressed(final MouseEvent e) {
        ...
        mainFrame
                ...
                .replace(
                        username,
                        new CustomUserPropertiesDTO(
                                username, nickname, customUserPropertiesDTO.borderColor()));
    ...
    protected void colorPickerPanelMouseClicked(MouseEvent e) {
        ...
        if (color != null) {
            ...
            mainFrame
                    ...
                    .replace(
                            selectedItem,
                            customUserPropertiesDTO.withBorderColor(

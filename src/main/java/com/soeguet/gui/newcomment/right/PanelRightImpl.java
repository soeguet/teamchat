...
public class PanelRightImpl extends PanelRight implements Comment {
    ...
    public PanelRightImpl(@NotNull MessageModel messageModel, String lastMessageFrom, @NotNull String lastPostTime) {
    ...
    protected void actionLabelMouseClicked(@NotNull MouseEvent e) {
        ...
        jDialog.pack();
        jDialog.setLocation(e.getLocationOnScreen().x - 20 - jDialog.getWidth(), e.getLocationOnScreen().y);

			...
			//======== form_panel1 ========
			{
				...
				//======== form_contentPanel ========
				{
					...
					//======== form_linkTextPanel ========
					{
						...
						((GridBagLayout)form_linkTextPanel.getLayout()).columnWidths = new int[] {0, 0};
						((GridBagLayout)form_linkTextPanel.getLayout()).rowHeights = new int[] {0, 0, 0, 0};
						((GridBagLayout)form_linkTextPanel.getLayout()).columnWeights = new double[] {1.0, 1.0E-4};
						((GridBagLayout)form_linkTextPanel.getLayout()).rowWeights = new double[] {0.0, 1.0, 1.0, 1.0E-4};
						form_linkTextPanel.add(form_vSpacer3, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
							GridBagConstraints.CENTER, GridBagConstraints.BOTH,

 ...
 * @author osmansogut
 */
public abstract class FeedbackDialog extends JFrame {
    ...
    private void initComponents() {
        ...
        //======== form_dialogPane ========
        {
            ...
            this.form_dialogPane.addKeyListener(new KeyAdapter() {
                @Override
            ...
            //======== form_contentPanel ========
            {
                ...
                //======== form_panel1 ========
                {
                    ...
                    this.form_replyTextPane.addKeyListener(new KeyAdapter() {
                        @Override
                        public void keyPressed(KeyEvent e) {
                ...
                this.form_emojiButton.addMouseListener(new MouseAdapter() {
                    @Override

...
public class InteractionButtonFactory extends JButton {
    ...
    // constructors -- start
    public InteractionButtonFactory(final MainFrameGuiInterface mainFrame, final BaseModel baseModel) {
    ...
    public CustomInteractionButton create() {
        ...
        CustomInteractionButton customInteractionButton = new CustomInteractionButton(mainFrame, baseModel);

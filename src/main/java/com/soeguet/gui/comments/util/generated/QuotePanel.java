	...
	private void initComponents() {
		...
		//======== form_panel3 ========
		{
			...
			//======== form_panel1 ========
			{
				...
				form_quoteTime.setFont(form_quoteTime.getFont().deriveFont(form_quoteTime.getFont().getSize() - 2f));
				...
				form_textField1.setFont(form_textField1.getFont().deriveFont(form_textField1.getFont().getSize() - 2f));
				...
				form_quoteSender.setFont(form_quoteSender.getFont().deriveFont(form_quoteSender.getFont().getSize() - 2f));

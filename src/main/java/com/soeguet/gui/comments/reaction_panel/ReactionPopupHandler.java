...
public class ReactionPopupHandler {
    ...
    /**
     Initializes a popup timer for showing a reaction popup menu. The popup timer is only initialized if it is not already running. The popup timer
     will show the reaction popup menu after a given delay.
     <p>
     The popup timer will be set with a delay of 2000 milliseconds (2 seconds). After the delay, the reaction popup menu will be shown at the current
     mouse position within the layered pane.
     <p>
     If the popup timer is already running, this method will do nothing and return.
     */
    ...
    /**
     ...
     <p>
     If the popup timer is currently running, it will be stopped. After stopping the popup timer, the instance variable 'popupTimer' will be set to
     null.
     <p>
     If the popup timer is not running or 'popupTimer' is null, this method will do nothing.
     */

...
public class EmojiPopUpMenuHandler implements EmojiPopupInterface {
  ...
  public EmojiPopUpMenuHandler(JTextPane textPane, JButton emojiButton) {
   ...
   *
   * <p>This method creates a JPanel and sets its layout to MigLayout with "wrap 10" constraints to
   * display emojis in a grid-like fashion. The panel is then returned.
   *

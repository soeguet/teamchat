...
public class EmojiRegister {
    ...
    /**
     ...
     class and calling the createEmojiList() method to obtain the list of emojis. The emoji list is then assigned to the
    ...
    /**
     ...
     corresponding image icons. The key in the HashMap represents the emoji text, and the value represents the

...
public class MainFrameTests {
  ...
  //
  //        assertEquals(
  //                "Paul", frame.getUsername(), "should return \"Paul\" from environment
  // variables");
  //    }
  //
  //    @Test
  ...
  //
  //        ChatMainFrameImpl obj = new ChatMainFrameImpl();
  //        NotificationStatusHandler notificationStatusHandler = new
  // NotificationStatusHandler(obj);
  //        assertEquals(
  //                notificationStatusHandler.getNotificationStatus(),
  // NotificationStatus.ALL_DENIED);
  //    }
  //
  //    @Test

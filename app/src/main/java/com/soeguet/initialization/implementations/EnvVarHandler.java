...
public class EnvVarHandler implements EnvVarHandlerInterface {
  ...
  public EnvVarHandler(
      final EnvDataProviderInterface envDataProvider,
      final UserInteractionInterface userInteraction) {
  ...
  private String retrieveUsername() {
    ...
    return (chatUsername != null && !chatUsername.isEmpty())
        ? chatUsername
        : userInteraction.askForUsername();
  }
